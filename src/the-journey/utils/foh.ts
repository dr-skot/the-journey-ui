...
export const timeToCodeWithTZ = (time: Date, tz: number = localTimezoneIndex()) => {
...
export const localTimezoneIndex = () => {
  const localTz = Intl.DateTimeFormat().resolvedOptions().timeZone;
  return timezones.indexOf(localTz);
}
