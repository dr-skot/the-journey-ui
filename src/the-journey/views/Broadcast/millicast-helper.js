...
let accountId  = 'Wu3EU2';
let streamName = 'keidk0k0';
...
function connect(videoElement) {
  ...
  pc.ontrack = function (event) {
    ...
    if (vidWin) {
      ...
      isConnecting = false;
      try {
        vidWin.requestFullscreen()
          .catch((err) => console.log('fullscreen error'))
      } finally {
      }
    }
  };
...
export function connectToStream(videoElement) {
